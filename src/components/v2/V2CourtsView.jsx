                ...
                <div className="min-w-0 flex-1">
                  ...
                  {isLadderRun ? (
                    ...
                    <p className="mt-0.5 text-xs text-slate-500">
                      {upNextPlayers.length > 0
                        ? leagueFreezeActive
                          ? 'Highlighted players are locked in and fill the next court when you generate. New check-ins wait until the next slate.'
                          : 'Next court slate of waiting players. Highlighted players fill the next court when you generate.'
                        : upNextEmptyMessage}
                    </p>
                  ) : (
                    <p className="mt-0.5 text-xs text-slate-500">
